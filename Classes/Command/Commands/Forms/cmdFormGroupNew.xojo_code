#tag Class
Protected Class cmdFormGroupNew
Implements Command
	#tag Method, Flags = &h0
	...
	#tag Method, Flags = &h0
		Sub execute()
		  ...
		  Dim tableColumns as Dictionary=SabreDatabaseManager.GetTableColumns(SabreDatabaseManager.kDB_MASTER_NAME, kDB_GROUPS)
		  ...
		  If tableColumns<>nil Then
		    ...
		    ccForm.formLabel(0).Text=kPG_GROUP_NEW
		    ...
		    ccForm.menuButton(0).Caption=kGROUP_CREATE

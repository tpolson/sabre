#tag Class
Protected Class cmdMenuUpdatePage
Implements Command
	#tag Method, Flags = &h0
	...
	#tag Method, Flags = &h0
		Sub execute()
		  ...
		  dim menuItems As String=data.Value(kCMD_MENU_LIST)
		  ...
		  for i=0 to ccUI.menuButtonCount
		    if i<menuCount then
		      ...
		      ccUI.menuButton(i).Top=(defaultButtonHeight*i)+defaultButtonHeight '+((ccUI.Height*.5)*displayIndex)
